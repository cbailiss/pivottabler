...
#'   totalCaption="Total", preGroupData=TRUE, baseStyleName=NULL, styleDeclarations=NULL)}}
#'   {Generate new data groups based on the distinct values in a data frame or
