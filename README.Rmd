...
The same styling/formatting used for the HTML output is also used when outputting to Excel - greatly reducing the amount of script that needs to be written to create Excel output.  Either the openxlsx or openxlsx2 packages can be used.
...
Example using openxlsx2 (note the renderer specified on the second line when creating the pivot table):
