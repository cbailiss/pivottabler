...
See the [Data Groups](datagroups.html) vignette for more details.
...
See the [Calculations](calculations.html) vignette for more details.
...
```{r, warning=FALSE, eval=TRUE, comment="", echo=FALSE}
library(pivottabler)
pt <- PivotTable$new()
pt$addData(bhmtrains)
pt$addColumnDataGroups("PowerType")
...
See the [Outputs](outputs.html) vignette for more details, including other conversion options such as converting a pivot table to a data frame.
...
See the [Styling](styling.html) vignette for more details.
...
See the [Finding and Formatting](findingandformatting.html) vignette for more details.
...
See the [Irregular Layout](irregularlayout.html) vignette for more details.
