...
- switching off the display of the values, with conditional formatting, for a chart of small coloured cells, like GitHub contributions chart.
...
- e.g. having multiple calculation groups.
