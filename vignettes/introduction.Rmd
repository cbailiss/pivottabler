...
pt$addData(bhmtrains)
pt$addLeafColumnDataGroup("TrainCategory")
pt$addLeafRowDataGroup("TOC", totalCaption="Grand Total")    #    << **** CODE CHANGE **** <<
pt$addLeafRowDataGroup("PowerType")
pt$addLeafRowDataGroup("SchedSpeedMPH", addTotal=FALSE)      #    << **** CODE CHANGE **** <<
pt$defineCalculation(calculationName="TotalTrains", summariseExpression="n()")
pt$renderPivot()
```
...
- Adding data groups based on the distinct values of a variable.
