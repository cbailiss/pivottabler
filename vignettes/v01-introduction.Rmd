...
Pivot tables are constructed natively in R, via a series of R commands that gradually build a pivot table to meet your needs. 
...
An example of a pivot table showing the number of trains operated by different train companies, rendered as a HTML widget, is:
