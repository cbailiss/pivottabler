...
This can then be rendered in outline layout, which renders row group data groups as headings: 
...
See the [Irregular Layout](v10-irregularlayout.html) vignette for more details.
