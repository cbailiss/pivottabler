...
* To specify which variables have totals and also renamed the captions of the total cells, specify a list, e.g. to rename the totals for x to "All x" and y to "All y", specify `totals=list("x"="All x", "y"="All y")`.

Returning to the previous quick pivot texample, the totals can now be renamed to "All ..." using:
