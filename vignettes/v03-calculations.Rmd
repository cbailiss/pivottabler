...
The above are the same approaches used when formatting data groups.  Examples of the first two approaches above can be found in previous examples in this vignette.  An example of the third approach and more details can be found in the [Data Groups](v02-datagroups.html) vignette.
