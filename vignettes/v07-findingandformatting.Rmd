...
Throughout this vignette, the `createInlineStyle` function is used.  This creates a new style in the pivot table and takes two arguments:  `baseStyleName` specifies the name of the style that the new style will be based on (i.e. will have it's style properties copied from) and `declarations` which specifies new/overriding style properties for the new style.
...
pt$addRowDataGroups("TOC")
pt$defineCalculation(calculationName="TotalTrains", summariseExpression="n()")
highlight <- pt$createInlineStyle(baseStyleName="ColumnHeader", 
                                  declarations=list("background-color"="#FFFF00"))
...
pt$defineCalculation(calculationName="TotalTrains", summariseExpression="n()")
highlight <- pt$createInlineStyle(baseStyleName="ColumnHeader", 
                                  declarations=list("background-color"="#00FFFF"))
...
The `getCells()` function can be used to retrieve one or more cells by row/column number in the body of the pivot table.  The arguments can be specified in two different ways depending on the value of the `specifyCellsAsList` argument.

For backward-compatibility reasons, the current default value of the `specifyCellsAsList` argument is `FALSE`.  This will be changed to `TRUE` in a future version of the pivottabler package.  For the moment, a message is displayed if `getCells()` is used without explicitly specifying the value of the `specifyCellsAsList` argument.
...
pt$defineCalculation(calculationName="TotalTrains", summariseExpression="n()")
pt$evaluatePivot()
highlight <- pt$createInlineStyle(baseStyleName="Cell", 
                                  declarations=list("background-color"="#FFCC66"))
...
pt$evaluatePivot()
highlight <- pt$createInlineStyle(baseStyleName="Cell", 
                                  declarations=list("background-color"="#00FF00"))
...
pt$evaluatePivot()
highlight <- pt$createInlineStyle(baseStyleName="Cell", 
                                  declarations=list("background-color"="#FF00FF"))
...
pt$defineCalculation(calculationName="TotalTrains", summariseExpression="n()")
pt$evaluatePivot()
redStyle <- pt$createInlineStyle(baseStyleName="Cell", 
...
greenStyle <- pt$createInlineStyle(baseStyleName="Cell", 
                                   declarations=list("background-color"="#C6EFCE", "color"="#006100"))
yellowStyle <- pt$createInlineStyle(baseStyleName="Cell", 
                                    declarations=list("background-color"="#FFEB9C", "color"="#9C5700"))
redStyle <- pt$createInlineStyle(baseStyleName="Cell", 
                                 declarations=list("background-color"="#FFC7CE", "color"="#9C0006"))
...
for(i in 1:length(cells)) {
  ...
  cell$style <- pt$createInlineStyle(baseStyleName="Cell", 
                                     declarations=list("background-color"=backClr, "color"=textClr))
}
pt$renderPivot()
```
