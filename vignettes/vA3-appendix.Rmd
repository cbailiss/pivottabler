...
It is possible (though not typical) for a pivot table to contain multiple calculation groups.  See the [Irregular Layout](v10-irregularlayout.html) vignette for an example.
