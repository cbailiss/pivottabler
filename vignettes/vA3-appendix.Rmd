...
* `pt$calculationGroups` contains the calculation groups present in a pivot table.  The calculation definitions within a group are accessed via `pt$calculationGroups$defaultGroup$calculations`.
...
* The data groups related to a cell can be accessed recursively via `cell$rowLeafGroup$parentGroup`, `cell$rowLeafGroup$parentGroup$parentGroup`, etc. 
