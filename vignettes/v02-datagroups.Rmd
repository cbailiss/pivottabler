...
Each data group has two values:  A `sortValue` that is used to order the group within the set of groups.  The `sortValue` is the same data type as the variable the data group is based on.  The `caption` is the value that is displayed in the pivot table.  The data type of the `caption` is typically character.
