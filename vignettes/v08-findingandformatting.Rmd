...
- `excludeEmptyGroups` - a logical value specifying whether to exclude empty groups (such as the empty groups associated with rows/columns in outlined layouts). 
...
- `excludeEmptyCells` - a logical value specifying whether to exclude empty cells (such as the empty cells associated with rows/columns in outlined layouts). 
