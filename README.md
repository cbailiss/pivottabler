...
The above is an image of a pivot table that has been generated by the pivottabler package using the default styling. The pivottabler package generates pivot tables as either HTML or Latex. (The HTML could not be directly used in this README as the Github styling changes the appearance of the HTML table).
